...
employment_type = np.random.choice(["salaried", "self_employed", "gig"], N, p=[0.55, 0.30, 0.15])
...
behaviour = pd.DataFrame({
    ...
    "txn_amount_inr": np.random.choice([199, 499, 999, 1999, 3999], M, p=[0.30, 0.28, 0.22, 0.13, 0.07]),
...
print(f"credit_applicants: {len(df)} rows")
print(f"txn_behaviour: {len(behaviour)} rows")
print("Done!")
