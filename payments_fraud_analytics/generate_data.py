...
# --- inject 15 burner account chargeback frauds ---
next_user_id = 351
for i in range(15):
...
ledger = pd.DataFrame(rows)  # 547 rows total
...
# --- gateway export with deliberate discrepancies ---
gateway = ledger.copy()
n = len(gateway)
...
print(f"gateway_export: {len(gateway)} rows")
